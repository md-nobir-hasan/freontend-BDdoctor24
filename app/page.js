  ...
  return (
    <div>
      <div className="bg-white">
        <nav className="flex items-center justify-between px-12 py-4 shadow-lg">
          <div className="">
            <Link href="/dashboard">
        ...
        <div className="flex justify-center items-center h-[50vh] m-0">
          <div className="relative flex flex-col gap-4">
            ...
            <div className="bg-[#003A9B] p-6 rounded-lg w-[1000px] grid grid-cols-6 gap-2">
              ...
              <Link
                className="col-span-1 bg-[#b8dbb8] hover:bg-[#43a047] hover:text-white text-[#3d3d3d] text-[20px] rounded-lg px-4 h-[44px]"
                href={{
                  pathname: "/dashboard",
                }}
              >
            ...
            {isDropdownVisible &&
              ...
              filteredDoctors.length === 0 && (
                <p className="text-[#2D2D2D] text-[18px] font-[600] mt-2">
                  No doctors found
                </p>
              )}
          </div>
